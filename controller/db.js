const pg = require('pg');
const account = require('../config/dbconfig');

const config = {
  user: account.user, //env var: PGUSER
  database: account.database, //env var: PGDATABASE
  password: account.password, //env var: PGPASSWORD
